...
** Last update Sun Jun  8 18:46:45 2014 borel_d
*/
...
int		check_limit_x(t_eye *eye, t_object *object,
			      double r1r2[2], double res[2])
{
...
int		check_limit_y(t_eye *eye, t_object *object,
			      double r1r2[2], double res[2])
{
